      ...
      <div class="main2">
         ...
         <div class="main2_bottom">
            <div class="main2_bottom1">
               ...
               <div class="main2_bb1">
                   <?php if(is_array($schools)): $k = 0; $__LIST__ = $schools;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$schools): $mod = ($k % 2 );++$k;?><div class="main2_school">
                           ...
                           <div class="name_school"><a href="<?php echo U('Home/SchoolsDetail/index',array('id'=>$schools['id']));?>"><?php echo ($schools["nickname"]); ?></a></div>
                           <div class="cost_school"><a href="<?php echo U('Home/SchoolsDetail/index',array('id'=>$schools['id']));?>"><?php echo ($schools["minprice"]); ?>/起</a></div>
                           <div class="human_school"><a href="<?php echo U('Home/SchoolsDetail/index',array('id'=>$schools['id']));?>"><span style="color:#FA7124; font-size: 14px;"><?php echo ($schools["student_num"]); ?></span>人已报名</a></div>
               ...
               <div class="main2_bb2">
                   <?php if(is_array($coachs)): $k = 0; $__LIST__ = $coachs;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$coachs): $mod = ($k % 2 );++$k;?><div class="main2_teacher">
                         ...
                         <div class="teacher_box">
                            <div class="teacher1">
                               <a href="" class="name_teacher"><?php echo ($coachs["nickname"]); ?></a>
                               <img src="/Public/website/Home/index/images/5_07.png" class="star">
                            </div>
                            <div class="teacher2">
                               <a href="" class="cost_teacher"><?php echo ($coachs["minprice"]); ?>元/起</a>
                               <a href="" class="apply_teacher"><span style="color:#FA7124; font-size: 16px; font-family:"微软雅黑";><?php echo ($coachs["student_num"]); ?></span>人已报名</a>
                            </div>
                         </div>
                      </div><?php endforeach; endif; else: echo "$empty" ;endif; ?>
                  <div class="more"><a href="">查看更多</a></div>
            ...
            <div class="main2_bottom3">
               ...
               <div class="main2_bb3">
                   <?php if(is_array($guiders)): $k = 0; $__LIST__ = $guiders;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$offers): $mod = ($k % 2 );++$k;?><div class="main2_teacher">
                           <?php if($k > 4): ?><div class="number_box1"><div class="number4"><?php echo ($k); ?></div></div>
                               <?php else: ?>
                               <div class="number_box1"><div class="number<?php echo ($k); ?>"><?php echo ($k); ?></div></div><?php endif; ?>
                           <div class="head_portrait"><div class="head"><a href=""><img src="/Public/website/Home/index/images/head1.png"></a></div></div>
                           <div class="teacher_box">
                               <div class="teacher1">
                                   <a href="" class="name_teacher"><?php echo ($offers["nickname"]); ?></a>
                                   <img src="/Public/website/Home/index/images/5_07.png" class="star">
                               </div>
                               <div class="teacher2">
                                   <a href="" class="cost_teacher"><?php echo ($offers["minprice"]); ?>元/起</a>
                                   <a href="" class="apply_teacher">已教学员<span style="color:#FA7124; font-size: 16px; font-family:"微软雅黑";><?php echo ($offers["student_num"]); ?></span>人</a>
                               </div>
                           </div>
                       </div><?php endforeach; endif; else: echo "$empty" ;endif; ?>
                  <div class="more"><a href="">查看更多</a></div>
   ...
   <div class="main_box3_1">
      <div class="main3_1">
         ...
         <div class="main3_1_bottom">
            <div class="hot_10">
                <?php if(is_array($hots)): $k = 0; $__LIST__ = $hots;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$hots): $mod = ($k % 2 );++$k;?><div class="main3_school">
                        ...
                        <div class="name_school3">
                            <a href="<?php echo U('Home/SchoolsDetail/index',array('id'=>$hotLeft['id']));?>"><?php echo ($hots["nickname"]); ?></a>
                        </div>
                    </div><?php endforeach; endif; else: echo "$empty" ;endif; ?>
               <div class="clearfix"></div>
            </div>
            <div class="hot_box">
               <div class="hot_left">
                   <?php if(is_array($hotsRight)): $i = 0; $__LIST__ = $hotsRight;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$hotsRight): $mod = ($i % 2 );++$i;?><div id="hot_school">
                           <div class="hot_school_top">
                               <a href="<?php echo U('Home/SchoolsDetail/index',array('id'=>$hotsRight['id']));?>" class="hot_s_name"><?php echo ($hotsRight["nickname"]); ?></a>
                               <p class="hot_s_jz"><?php echo ($hotsRight["jtype"]); ?>照</p>
                               <p class="hot_s_h">￥<?php echo ($hotsRight["highprice"]); ?></p>
                               <p class="hot_s_n">￥<?php echo ($hotsRight["minprice"]); ?>起</p>
                               <div class="clearfix"></div>
                           </div>
                           <div class="hot_school_bottom">
                               <p class="hot_s_t">已有<?php echo ($hotsRight["student_num"]); ?>名学员报名</p>
               ...
               <div class="hot_right">
                   <?php if(is_array($hotsRight1)): $i = 0; $__LIST__ = $hotsRight1;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$hotsRight): $mod = ($i % 2 );++$i;?><div id="">
                           <div class="hot_school_top">
                               <a href="<?php echo U('Home/SchoolsDetail/index',array('id'=>$hotsRight['id']));?>" class="hot_s_name"><?php echo ($hotsRight["nickname"]); ?></a>
                               <p class="hot_s_jz"><?php echo ($hotsRight["jtype"]); ?>照</p>
                               <p class="hot_s_h">￥<?php echo ($hotsRight["highprice"]); ?></p>
            ...
            <div class="hot_image">
                <?php if(is_array($hotsRight1)): $i = 0; $__LIST__ = $hotsRight1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="image_every"><a href=""><img src="/Uploads/School_logo/<?php echo ($v["picurl"]); echo ($v["picname"]); ?>"></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
            <div class="clearfix"></div>
         </div>
