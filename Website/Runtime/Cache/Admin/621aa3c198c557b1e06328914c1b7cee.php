...
<div style="font-size: 11px;margin: 10px 5px">
    <form action="<?php echo U('Admin/guider/editor_zd');?>" method="post" id="form1" enctype="multipart/form-data">
        ...
        <table width="100%" class="table_a">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="account"  value="<?php echo ($jl['account']); ?>" style="width:300px" />
                </td>
            </tr>
            <tr>
                <td>指导员姓名：</td>
                <td>
                    <input type="text" name="nickname" value="<?php echo ($jl['nickname']); ?>" style="width:300px"  />
                </td>
            </tr>
            <tr>
                <td>性&nbsp;&nbsp;别：</td>
            ...
            <tr>
                <td>驾照类型</td>
                <td><input type="text" name="jtype" style="font-size: 10px;width: 170px" value="<?php echo ($jl["jtype"]); ?>"/>（多个可用英文逗号隔开）</td>
            </tr>
            <tr>
                <td>身份证号：</td>
                <td><input type="text" name="numberId" value="<?php echo ($jl["numberid"]); ?>" style="width:300px" /></td>
            </tr>
            <tr>
                <td>驾驶证号：</td>
                <td><input type="text" name="driverId" value="<?php echo ($jl["driverid"]); ?>"   style="width:300px" /></td>
            </tr>
            <tr>
                <td>车牌号：</td>
                <td><input type="text" name="carnumber" value="<?php echo ($jl["carnumber"]); ?>"  style="width:300px" /></td>
            </tr>
            <tr>
                <td>教练证号：</td>
                <td><input type="text" name="serialid" value="<?php echo ($jl["serialid"]); ?>" style="width:300px"  /></td>
            </tr>
            <tr>
                <td>年&nbsp;&nbsp;龄：</td>
                <td><input type="text" name="age" value="<?php echo ($jl["age"]); ?>"  style="width:300px"/></td>
            </tr>
            <tr>
                <td>驾&nbsp;&nbsp;龄：</td>
                <td><input type="text" name="driverage"  value="<?php echo ($jl["driverage"]); ?>" style="width:300px"/></td>
            </tr>
            <tr>
                <td>教&nbsp;&nbsp;龄：</td>
                <td><input type="text" name="teachage" value="<?php echo ($jl["teachage"]); ?>" style="width:300px"/></td>
            </tr>
            <tr>
                <td>联系电话：</td>
                <td><input type="text" name="phone" value="<?php echo ($jl["phone"]); ?>" style="width:300px"  /></td>
            </tr>
            <tr>
                <td>评论数：</td>
                <td><input type="text" name="evalutioncount" value="<?php echo ($jl["evalutioncount"]); ?>" style="width:300px" /></td>
            </tr>
            <tr>
                <td>总学员数：</td>
                <td><input type="text" name="student_num"  value="<?php echo ($jl["student_num"]); ?>" style="width:300px"/></td>
            </tr>
            <tr>
                <td>已通过人数：</td>
                <td><input type="text" name="passedcount" value="<?php echo ($jl["passedcount"]); ?>" style="width:300px"/></td>
            </tr>
            <tr>
                <td>地&nbsp;&nbsp;址：</td>
                <td><input type="text" name="address" value="<?php echo ($jl["address"]); ?>" style="width:300px"/></td>
            </tr>
            <tr>
                <td>计时培训：</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div class="usercity" style="border:3px dashed #e6e6e6;width:210px;height:200px;position: relative;margin-bottom: 15px">
                        <p id="preview1" >
                            <?php if($jl['picname'] != ''): ?><img id="imghead1"  border=0 src="<?php echo ($http); ?>/Uploads/guider_logo/<?php echo ($jl['picurl']); echo ($jl['picname']); ?>" width="150" height="120">
                                <?php else: ?>
    ...
    $(function(){
        $('#school_id').click(function(){
            layer.open({
                ...
                area:["600px",'600px'],
                content:"<?php echo U('Admin/Coach/edit_school');?>?cityid="+$("#cityid").val()
