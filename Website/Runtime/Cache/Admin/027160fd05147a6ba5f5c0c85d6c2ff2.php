...
<html>
    ...
    <body>
        <div class="div_head">
            教练列表
            <a style="text-decoration: none;color: #FA7124" href="<?php echo U('add_jl',array('type'=>'jl','pid'=>$get['pid'],'p'=>$get['p']));?>">【教练添加】</a>
        ...
        <div class="div_search">
            <span>
                <form action="?" id='form' method="get">
                    ...
                    教练名称：<input type="text" name='nickname' value="<?php echo ($get['nickname']); ?>" />
                    教练账号：<input type="text" name='account' value="<?php echo ($get['account']); ?>"/>
                ...
                <tbody>
                    ...
                    <form action="" id="form2">
                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr>
                                ...
                                <td>
                                    <?php if($v['picname'] != ''): ?><img src="<?php echo ($http); ?>/Uploads/Coach_logo/<?php echo ($v['picurl']); echo ($v['picname']); ?>" alt="" style="border-radius:50%" width="50" height="50" />
                                        <?php else: ?>
                                ...
                                <td>
                                    <a class="tablelink" href="<?php echo U('Admin/TrainClass/train_class',array('id'=>$v['id'],'type'=>$v['type'],'pid'=>$get['pid'],'p'=>$get['p']));?>"><?php echo ($v['class_num']); ?></a>
                                </td>
                                <td>
                                ...
                                <td><a class="tablelink"  href="<?php echo U('LandMark/see_land',array('id'=>$v['id'],'type'=>$v['type'],'pid'=>$get['pid'],'p'=>$get['p']));?>">查看</a></td>
                                <td><?php echo ($v["score"]); ?></td>
                                <td><?php echo ($v["carnumber"]); ?></td>
                                <td><?php echo ($v["cityname"]); ?></td>
                                <!--<td>-->
                                    <!--<a  href="javascript:;" class="tablelink" onclick="status_update(<?php echo ($v['id']); ?>,<?php echo ($get['pid']); ?>,'week',<?php echo ($get['p']?$get['p']:1); ?>)"><?php echo ($v['week']?'取消本周':'本周'); ?></a>-->
                                <!--</td>-->
                                <!--<td>-->
                                ...
                                <td>
                                    <a class="tablelink" href="<?php echo U('Admin/Environment/abstract_pic',array('id'=>$v['id'],'type'=>$v['type'],'pid'=>$get['pid'],'p'=>$get['p'],'t'=>1));?>">教学环境</a>　
                                    <span>|</span>
                                    ...
                                    <span>|</span>
                                    <a class="tablelink" href="<?php echo U('editor_jl?id='.$v['id'].'&p='.$get['p'].'&pid='.$get['pid'].'&type='.$v['type']);?>">编辑</a>　
                                    <span>|</span>
