...
<html>
    <head>
        ...
        <style>
            .dfinput{margin: 25px 0;border:solid 2px rgba(39, 183, 243, 0.87);border-radius: 3px;
    ...
    <body>
        ...
        <table cellspacing=0 cellpadding=0 width="95%" align=center border=0>
            ...
            <tr height=22 width=200 >
                <td style="font-weight: bold; color: #ffffff;background-color: #13b5b1;width: 200px;" align=middle>
                    您的相关信息
                </td>
            </tr>
