...
<body>
<div class="div_head">
    管理员日志(一个月内)  <a style="text-decoration: none;color:#FA7124" href="<?php echo ($get['url']); ?>">【返回】</a>
    <a href="" style="text-decoration: none">【刷新】</a>
...
<div class="div_search" >
    <span>
        <form action="?" id='form1' method="get" name="form1">
            ...
            <input type="hidden" name="pp" value="<?php echo ($get['pp']); ?>"/>
            ...
            <input value="导出" style="font-size: 11px" type="submit" id="button" onclick="submitYouFrom('<?php echo U("Admin/AdminLog/push",array('t'=>$get['t']));?>')"/>
...
<div style=" margin: 10px 5px;">
    <table class="table_a" width="100%">
        ...
        <?php if(is_array($adminLog)): $k = 0; $__LIST__ = $adminLog;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr>
                ...
                <td style="text-align: left;word-break: break-all"><?php echo ($v['done']); ?></td>
