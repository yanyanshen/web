...
<!--<div class="div_search">-->
    <!--<span>-->
        <!--<form action="<?php echo U('Admin/School/week_list',array('pid'=>$get['pid']));?>" method="get">-->
...
<div style="margin-left: 6px">
    ...
    <input type="button" value='取消' onclick="cancel('week')" style="font-size: 12px;font-weight:bold;background-color:rgb(247, 247, 247);border-radius: 3px;border:none;color: #646464;width: 60px;padding: 2px 0"/>
    <script>
    ...
    <table class="table_a"  width="100%">
        <tbody>
            ...
            <form action="" id="form2">
                <?php if(is_array($week_list)): $k = 0; $__LIST__ = $week_list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr>
                        <td><input type="checkbox" name="id[]" value="<?php echo ($v["school_id"]); ?>"/></td>
                        <td>
                            <input type="text" value="<?php echo ($v["order"]); ?>" id="pri<?php echo ($v["school_id"]); ?>" onchange="setPriority(this,<?php echo ($v["school_id"]); ?>)" style="width: 30px;"/>
                        </td>
