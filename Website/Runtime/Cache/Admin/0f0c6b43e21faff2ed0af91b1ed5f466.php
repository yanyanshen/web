    ...
    <div class="div_search">
        <span>
            <form action="?" id='form1' method="get">
                ...
                <input value="查询" style="font-size: 12px" type="submit" onclick="submitYouForm('<?php echo U("Admin/Order/order_keyword",array('pid'=>$get['pid']));?>')"/>
                <input value="上月" style="font-size: 12px" type="submit" onclick="submitYouForm('<?php echo U("Admin/Order/order_keyword",array('t'=>1,'pid'=>$get['pid']));?>')"/>
                <script>
    ...
    <table class="table_a"  width="100%">
        <tbody>
            ...
            <?php if(is_array($order_source)): $i = 0; $__LIST__ = $order_source;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($v['end_lv']?$v['end_lv']:0); ?></td>
