...
<!--<div class="div_search">-->
    <!--<span>-->
        <!--<form action="<?php echo U('Admin/School/hot_list',array('pid'=>$get['pid']));?>" id='form' method="get">-->
...
<div style="margin-left: 6px">
    ...
    <input type="button" value='取消' onclick="cancel('hot')" style="font-size: 12px;font-weight:bold;background-color:rgb(247, 247, 247);border-radius: 3px;border:none;color: #646464;width: 60px;padding: 2px 0"/>
    <span style="color: #FA7124;">注意：前端页面最多可放13个以防止排版杂乱多余的可取消</span>
    <script>
