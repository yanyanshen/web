...
<head>
    ...
    <link href="/Public/website/Mobile/user/user_center/css/setUp.css" rel="stylesheet" type="text/css">
...
<div id="pagewrap">
    ...
    <div class="main_box">
        <div class="main">
            <div class="set_box">
                <div class="password">
                    <div class="paw_img"><img src="/Public/website/Mobile/user/user_center/images/icon-footer01-a.png"></div>
                    <a href="<?php echo U('Mobile/User/resetPassword');?>" class="set_password">重设密码</a>
                    <div class="paw_back"><img src="/Public/website/Mobile/user/user_center/images/back1.png"></div>
                    <div class="clearfix"></div>
                </div>
            </div>
            <div class="login_out">
                <div class="button_box"><button id="login_out">退出登录</button></div>
            </div>
        </div>
    </div>
...
<script>
    $("#login_out").click(function(){
        layer.open({
            ...
            ,btn: ['是', '不要']
            ,yes: function(index){
                $.post('<?php echo U("Mobile/User/login_out");?>','',function(res){
