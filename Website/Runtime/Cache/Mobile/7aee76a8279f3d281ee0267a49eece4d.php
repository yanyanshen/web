...
<div id="pagewrap">
    <div class="header_box">
        <div class="header">
            <ul>
                <a href="<?php echo U('Mobile/Index/index');?>"><li class="back" style="padding-right: 50px"><img src="/Public/public/images/back.png"></li></a>
    ...
    <div class="main_box">
        ...
        <div class="sms_box">
            <a href="">
                <img src="/Public/public/images/sms.png">
            </a>
