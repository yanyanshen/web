            ...
            <div class="user_top">
                <?php if($_SESSION['xueches_']['mid']== ''): ?><a href="<?php echo U('Mobile/Login/login');?>">
                        <div class="user_header">
                            <img src="/Public/website/Mobile/user/user_center/images/header1.jpg">
                        </div>
                    </a>
                    <div class="user_name">
                        <h1>点击登录</h1>
                    ...
                    <div class="user_name">
                        <h1><?php echo ($user["truename"]); ?></h1>
                    </div>
                    <div class="user_tel">
                        <h2 id="tel"><?php echo ($user["account"]); ?></h2>
                        <h3 style="color: #FA7124">如果您没有设置过密码请尽快设置新的密码</h3>
                    </div><?php endif; ?>
