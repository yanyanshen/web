    ...
    <div class="header_box" style="z-index: 3000">
        ...
        <div id="pullrefresh" style="margin-top: 15%" class="mui-content mui-scroll-wrapper">
            <div class="main mui-scroll" >
                <div class="studyNew">
                    <div class="new">
                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div id="n_box1">
                                <a href="<?php echo U('Mobile/Consult/studyNew_detail',array('id'=>$data['id']));?>">
                                    <div class="n_img">
                                        <img src="<?php echo ($http); ?>/Uploads/Consult_logo/<?php echo ($data["picurl"]); echo ($data["picname"]); ?>" width=""/>
                                    </div>
                                </a>
                                <div class="n_main">
                                    <a href="<?php echo U('Mobile/Consult/studyNew_detail',array('id'=>$data['id']));?>"><?php echo (mb_substr($data["title"],0,12,utf8)); ?>...</a>
                                    <ul id="nm">
                    ...
                    $.each(data, function (index, array) {
                        if(array['id']){
                            ...
                            str += '<a href="'+"<?php echo U('Mobile/Consult/studyNew_detail');?>?id="+array['id']+'">';
                                str += '<div class="n_img">';
                                str += '<img src="<?php echo ($http); ?>/Uploads/Consult_logo/'+array['picurl']+array['picname']+'"/>';
                                str += '</div>';
                            str += '</a>';
