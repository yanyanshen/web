...
<head>
    ...
    <link href="/Public/website/Mobile/user/user_center/css/forgetPassword.css" rel="stylesheet" type="text/css">
...
<div id="pagewrap">
    <div class="header_box">
        <div class="header">
            <ul>
                <a href="<?php echo U('Mobile/Login/login');?>">
                    <li class="back" style="padding-right: 50px"><img src="/Public/public/images/back.png"></li>
                </a>
            ...
            <form class="set_box" id="form1">
                ...
                <div class="password_reset4">
                    ...
                    <cite style="border-radius: 10px">
                        <img src="<?php echo U('Mobile/Login/verify');?>" width="100" height="50" alt="" style="float: right;vertical-align: middle;cursor: pointer"
                             onclick="this.src='<?php echo U('Mobile/Login/verify',rand());?>'"/>
                    </cite>
                </div>
                <div class="login_out">
 ...
 $(function(){
     var validate = $("#form1").validate({
         ...
         rules:{
             ...
             verify:{required:true, remote:{url:'<?php echo U("Mobile/Login/verify_check");?>',type:'post'}
             }
         },
         messages:{
...
//手机号验证
     ...
     $("#form1").submit(function(){
         if(validate.form()){
             $.post('<?php echo U("Mobile/Login/forgetPassword");?>',$("#form1").serialize(),function(res){
                 if(res.status){
                     layer.open({
                         content:res.info,time:2
                         ,end:function(){
                     ...
                     layer.open({
                         content:res.info, time:2, end:function(){
                             location.href = res.url;
                         }
                     })
                 }
