...
<head>
    ...
    <link href="/Public/website/Mobile/user/user_center/css/resetPassword.css" rel="stylesheet" type="text/css">
...
<div id="pagewrap">
    ...
    <div class="header_box">
        <div class="header">
            <ul>
                <li class="back"><a href="<?php echo U('Mobile/User/setUp');?>">
    ...
    <div class="main_box">
        <div class="main">
            <form class="set_box" id="form1">
                ...
                <div class="login_a">
                    <div class="a_box"><a href="<?php echo U('Mobile/User/forgetPassword');?>">忘记密码？</a></div>
                </div>
            </form>
        </div>
    </div>
...
<script>
    $(function(){
        var validate = $("#form1").validate({
            //设置规则
            rules:{
                order_pwd :{required:true,remote:{url:'<?php echo U("Mobile/Login/pwd_check");?>', type:'post'}}
        ...
        $("#form1").submit(function(){
            ...
            if(validate.form()){
                $.post('<?php echo U("Mobile/Login/resetPassword");?>',$("#form1").serialize(),function(res){
                    if(res.status == 1){
                        layer.open({
                            content: res.info
                            ...
                            ,time: 1
                            ,end:function(){
                                location.href = "<?php echo U('Mobile/Login/login');?>";
                            }
                        })
                    }else{
                        layer.open({
