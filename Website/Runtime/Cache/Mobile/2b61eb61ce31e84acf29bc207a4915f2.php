...
<div id="pagewrap">
    ...
    <form action="<?php echo U('Mobile/WayPay/pay_money');?>" method="post" id="form1" onsubmit ="getElementById('btn2').disabled=true;return true;">
        <input type="hidden" name="WIDout_trade_no" value="<?php echo ($ordcode); ?>"/>
        ...
        <footer id="footer">
            <div class="apply_submit">
                <input  style="line-height: 1%;border: 0;-webkit-appearance:none;" type="submit" id="btn2" value="立即支付">
            </div>
        </footer>
    </form>
</div>
