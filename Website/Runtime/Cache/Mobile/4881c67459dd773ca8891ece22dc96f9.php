...
<html>
	<head>
        ...
        <style>
            ...
            .cur{
                width:8px;height:8px;margin:0 1px;display:inline-block;-webkit-border-radius:5px;border-radius:5px;background-color:#fff;
            }
        </style>
	</head>
<body>
    <div id="pagewrap">
        <div style="background: #fff;border-bottom: 2px;height: 51px;margin: 0;border-bottom: 1px solid #efefef;" >
                ...
                <div class="search_box" style="float: right;margin-right: 3%">
                    <form action="<?php echo U('Mobile/List/pull');?>" method="get" style="margin: 0;padding: 0">
                        <input type="text" name="k" value="<?php echo (session('k')); ?>" placeholder="请输入驾校或街道" id="keyword" style='background: #fff;width: 81%;height: 26px;font-size:15px;border-radius: 5px;font-family: "Microsoft yahei" '  />
                ...
                <div class="clearfix"></div>
                <div id="recomment" style="margin-top: 0;" >
                    <div class="rl-school" style="z-index: 1000">
                        <div class="rr_box" style="margin-left: 11%;">
                            <div class="rr" >
                                <?php if($_SESSION['xueches_']['r']== 1): ?><a style="padding: 0 6px 0 6px;" class="color" href="<?php echo U('Mobile/List/pull',array('r'=>1));?>">
                                        推荐
                                        <div class="rr_img" style="float: right">
                                            <img src="/Public/website/Mobile/list/images/jt01.png">
                                        </div>
                                    </a>
                                    <?php else: ?>
                                    <a style="color: #646464;padding: 0 6px 0 6px;" href="<?php echo U('Mobile/List/pull',array('r'=>1));?>">推荐
                                        <div class="rr_img" style="float: right">
                                            <img src="/Public/website/Mobile/list/images/jt01.png">
                                        </div>
                                    </a><?php endif; ?>
                        ...
                        <div class="dr_box">
                            <div class="dr">
                                <?php if($_SESSION['xueches_']['all']== 1): ?><a class="color" style="padding: 0 6px 0 6px;" href="<?php echo U('Mobile/List/pull',array('all'=>1));?>">人气
                                        <div class="rr_img" style="float: right">
                                            <img src="/Public/website/Mobile/list/images/jt01.png">
                                        </div>
                                    </a>
                                    <?php else: ?>
                                    <a style="color: #323232;padding: 0 6px 0 6px;" href="<?php echo U('Mobile/List/pull',array('all'=>1));?>">人气
                                        <div class="rr_img" style="float: right">
                                            <img src="/Public/website/Mobile/list/images/jt01.png">
                                        </div>
                                    </a><?php endif; ?>
                        ...
                        <div class="mr_box" >
                            <div class="mr">
                                <?php if($_SESSION['xueches_']['p']== 1): ?><a class="color" style="padding: 0 6px 0 6px;"  href="<?php echo U('Mobile/List/pull',array('p'=>1));?>">
                                        价格
                                        <div style="float: right" class="rr_img">
                                            <img src="/Public/website/Mobile/list/images/jt01.png">
                                        </div>
                                    </a>
                                    <?php else: ?>
                                    <a style="color: #646464;padding: 0 6px 0 6px;" href="<?php echo U('Mobile/List/pull',array('p'=>1));?>">
                                        价格
                                        <div style="float: right" class="rr_img">
                                            <img src="/Public/website/Mobile/list/images/jt01.png">
                                        </div>
                        ...
                        <div class="er_box">
                            <div class="er">
                                <?php if($_SESSION['xueches_']['e']== 1): ?><a class="color" style="padding: 0 6px 0 6px;" href="<?php echo U('Mobile/List/pull',array('e'=>1));?>">评价
                                        <div style="float: right" class="rr_img">
                                            <img src="/Public/website/Mobile/list/images/jt01.png">
                                        </div>
                                    </a>
                                    <?php else: ?>
                                    <a style="color: #646464;padding: 0 6px 0 6px;" href="<?php echo U('Mobile/List/pull',array('e'=>1));?>">评价
                                        <div style="float: right" class="rr_img">
                                            <img src="/Public/website/Mobile/list/images/jt01.png">
                                        </div>
                                    </a><?php endif; ?>
        ...
        <div class="addWrap" style="position:absolute; width:100%;background:#fff;margin-top:32px; padding:0;">
                <div class="swipe" id="mySwipe" style="overflow: hidden;visibility: hidden;position:relative;width:100%;">
                    <div class="swipe-wrap" style="overflow:hidden;position:relative;width:100%;">
                        <?php if(is_array($slideshow)): $i = 0; $__LIST__ = $slideshow;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div style="float: left;width: 100%;position:relative;">
                                <a href="<?php echo U($data['href']);?>">
                                    <img style="display: block; max-width: 100%;  height: auto;" class="img-responsive" src="<?php echo ($http); ?>/Uploads/Slideshow_logo/<?php echo ($data['picurl']); echo ($data['picname']); ?>"/>
                                </a>
                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
                <ul id="position" style="position:absolute; bottom:0; right:0; padding-right:8px; margin:0; width:30%; filter: alpha(opacity=50);text-align:right;">
                    <li style="" class="cur"></li>
                    <li class=""></li>
                    <li class=""></li>
                    <li class=""></li>
                </ul>
        ...
        <script type="text/javascript">
            ...
            <!--下拉刷新容器-->
        <div  style="margin-top: 130px;z-index: 1" id="pullrefresh"  class="mui-content mui-scroll-wrapper">
				...
				<ul class="mui-table-view mui-table-view-chevron">
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li style="width: 96%;padding: 3% 0;margin: 0;" class="mui-table-view-cell">
                            <div id="r_main" style="border-bottom: none">
                                <a href="<?php echo U('Mobile/Detail/index',array('id'=>$v['id'],'type'=>$v['type']));?>"><?php echo ($v["nickname"]); ?>
                                    <div class="clearfix"></div>
                                    <ul id="rm">
                                        <li style="font-size: 12px" class="money">￥<?php echo ($v["minprice"]); ?></li>
                                        <li class="num" style="font-size: 10px"><?php echo ($v["student_num"]); ?>人已报名</li>
                                    </ul>
			                        </a>
                                <a href="<?php echo U('Mobile/Detail/index',array('id'=>$v['id']));?>#detail" style="color: white;font-size: 11px">
                            ...
                            <div id="r_img" style="border:1px solid #eee;border-radius: 3px">
                                <?php if($v['type'] == 'jx'): ?><a href="<?php echo U('Mobile/Detail/index',array('id'=>$v['id'],'type'=>$v['type']));?>">
                                        <img src="<?php echo ($http); ?>/Uploads/School_logo/<?php echo ($v["picurl"]); echo ($v["picname"]); ?>">
                                    </a><?php endif; ?>
                                <?php if($v['type'] == 'jl'): ?><a href="<?php echo U('Mobile/Detail/index',array('id'=>$v['id'],'type'=>$v['type']));?>">
                                        <img src="<?php echo ($http); ?>/Uploads/coach_logo/<?php echo ($v["picurl"]); echo ($v["picname"]); ?>">
                                    </a><?php endif; ?>
                                <?php if($v['type'] == 'zd'): ?><a href="<?php echo U('Mobile/Detail/index',array('id'=>$v['id'],'type'=>$v['type']));?>">
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (index, array) {
                                if(array['id']){
                                    ...
                                    str += '<a  href="'+"<?php echo U('Mobile/Detail/index');?>?id="+array['id']+'&type='+array['type']+'">'+array['nickname'];
                                    str += '<div class="clearfix"></div>';
                                    str += '<ul id="rm">';
                                    str += '<li class="money">￥'+array['minprice']+'</li>';
                                    str += '<li class="num" style="font-size: 10px">'+array['student_num']+'人已报名</li>';
                                    str += '</ul>';
				                    str += '</a>';
                                    str += '<a style="color:white;font-size:11px" href="'+"<?php echo U('Mobile/Detail/index');?>?id="+array['id']+'#detail">';
                                    str += '<button style="margin-right: 0">马上报名</button></a>';
                                    str += '<div class="clearfix"></div>';
                                    str += '</div>';
                                    str += '<div id="r_img" style="border:1px solid #eee;border-radius: 3px">';
                                    if(array['type'] == 'jx'){
                                        str += '<a href="'+"<?php echo U('Mobile/Detail/index');?>?id="+array['id']+'&type='+array['type']+'#detail">';
