        ...
        for(key in oCity){
            ...
            for(var j=0,k = sortKey.length;j<k;j++){
                ...
                for(var i=0,n=oCity[key][sortKey[j]].length;i<n;i++){
                    ...
                    k1 = k1.substring(-3);
                    str='<a id="a" href="http://www.517xc.cn?city='+k1+'">'+oCity[key][sortKey[j]][i]+'</a>';
                    odda.push(str);
                }
            ...
            for (var i = 0, n = Vcity.allCity.length; i < n; i++) {
                if (reg.test(Vcity.allCity[i])) {
                    ...
                    if (searchResult.length !== 0) {
                        str = '<a href="http://www.517xc.cn?city='+match[2]+'">'+ '<li><b class="cityname">' + match[1] + '</b><b class="cityspell">' + match[2] + '</b></li>'+'</a>'
                    } else {
                        str = '<a href="http://www.517xc.cn?city='+match[2]+'">'+
